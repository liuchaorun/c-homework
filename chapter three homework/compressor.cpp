...
//void showall(bitset<4> *bits,int i){
//    if(i==4){
...
//    else{
//        //cout<<bits->to_string()<<endl;
//        string a = bits->to_string().substr((uint8_t)(4-i),3);
//        //cout<<i<<a+ZERO<<endl;
//        showall(new bitset<4>(a+ZERO),i+1);
//        //cout<<i<<a+ONE<<endl;
//        showall(new bitset<4>(a+ONE),i+1);
//    }
//};
//
//int main(){
...
//    bitset <8> b(0x9f);
//    uint8_t a = 0;
//    ofstream ofs( "D:///1.dat", ios::binary);
